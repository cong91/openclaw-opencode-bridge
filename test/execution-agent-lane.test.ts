				...
				JSON.stringify([
					{
						...
						title: `task-agent-lane-1 runId=run-agent-lane-1 taskId=task-agent-lane-1 requested=creator resolved=plan callbackSession=agent:creator:opencode:creator:callback:04577833-156b-4989-80ab-13067a0949f3 originSession=agent:creator:telegram:direct:5165741309 originSessionId=04577833-156b-4989-80ab-13067a0949f3 callbackRelaySession=agent:creator:telegram:direct:5165741309 callbackRelaySessionId=04577833-156b-4989-80ab-13067a0949f3 callbackDeliver=false projectId=proj-agent-lane-1 repoRoot=${join(tempRoot, "repo")}`,
